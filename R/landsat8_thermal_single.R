...
kc_l8t = function(doy, RG, a, b){
  ...
  rm(b1, b2, b3, b4, b5, b6, b7, b1_mascara, b2_mascara, b3_mascara, b4_mascara, b5_mascara,b6_mascara,b7_mascara, mascara, slope, R, Ws, E0, cos_zwn, W, Dec, LAT, Et, map1, lati, long)
...
evapo_l8t = function(doy, RG, ET0, a, b){
  ...
  rm(b1, b2, b3, b4, b5, b6, b7, b1_mascara, b2_mascara, b3_mascara, b4_mascara, b5_mascara,b6_mascara,b7_mascara, mascara, slope, Rn_coeff, RsTOP, RsTOP_aux, R, Ws, E0, cos_zwn, W, Dec, LAT, Et, map1, lati, long)
...
radiation_l8t =  function(dj, RG, ET0, a, b){
